    ...
    validateStepData(stepNumber) {
        ...
        switch(stepNumber) {
            ...
            case 6:
                ...
                break;
            case 7:
                // For Step 7, allow progression regardless of calculation state
                // Users can continue without calculating if they choose
                break;
            case 8:
...
_Generated by AB Test Setup Guide_`;
    ...
    continueToNextStep() {
        ...
        // Manually set the step number since we're not coming from an event
        const stepNumber = 7; // Calculator is step 7
    ...
    generateTimelineDisplay(statisticalWeeks, recommendedWeeks, mdePoints, variations, sampleSize) {
        return `<strong>Average run duration: ${recommendedWeeks} weeks</strong>`;
    }
    ...
    calculateTimeline() {
        ...
        setTimeout(() => {
            ...
            // Generate simplified timeline display
            ...
            resultSummary.innerHTML = timelineDisplay;
